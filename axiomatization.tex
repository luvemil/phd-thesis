...
\begin{prop}
  ...
  \begin{enumerate}[label=(a)]
    \item $f$ is a monomorphism in $\mathcal{H}$ if and only if there is a pseudokernel
    $\PKer_{\mathcal{F}_2}(f)\in\mathcal{F}_1$;
    \item $f$ is an epimorphism in $\mathcal{H}$ if and only if there is a pseudocokernel
