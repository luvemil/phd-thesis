...
\begin{expl}\label{E:examples-proj} Let $(\A, \B)$ be a hereditary complete cotorsion pair in a  Grothendieck category $\G$.
 \begin{enumerate}
...
\begin{thm}\label{T:triple-B}  Let $(\A, \B)$ be a hereditary complete cotorsion pair in a  Grothendieck category $\G$ such that $\A$ contains a generator of finite projective dimension.
...
%
\begin{thm}\label{T:recollement-inj-A} Let $(\A, \B)$ be a hereditary complete cotorsion pair in a  Grothendieck category $\G$ such that $\A$ is deconstructible. Then, there is a recollement:
