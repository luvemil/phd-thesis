...
\begin{definition}
  ...
  \begin{torsionaxioms}
    \item $\mathbb{t}_1=(\mathcal{T}_1,\mathcal{F}_1)$ and $\mathbb{t}_2=(\mathcal{T}_2,\mathcal{F}_2)$ are respectively a left functorial and a
    right functorial torsion pair \todo{define torsion pairs in additive categories}
    \item $\mathcal{T}_2\subseteq \mathcal{T}_1$ (equiv. $\mathcal{F}_1\subseteq\mathcal{F}_2$)
    ...
    \varitem{^\ast} Dual of \ref{ax:ct3}.
  \end{torsionaxioms}
\end{definition}
...
\begin{prop}
  ...
  \begin{enumerate}
    \item[(a)] if $f^C:H_2\to T_1$ is the pseudocokernel of $f$, given by \ref{ax:ct3}
  \end{enumerate}
\end{prop}
