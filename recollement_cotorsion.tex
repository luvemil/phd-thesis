...
\begin{lem} Let $(\A,\B)$ be a cotorsion pair in a Grothendieck category generated by a set $\clS$. Then, $\A$ is generating if and only if $(\A,\B)$ is complete.

Moreover, in these equivalent hypotheses, $\A$ is deconstructible and, if $\clS'=\clS \cup \{G\}$, where $G\in\A$ is a generator, then $\A = \F ilt^{\oplus}\,\clS'$.
\end{lem}
