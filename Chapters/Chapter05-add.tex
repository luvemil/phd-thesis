...
\begin{thm}\label{thm_2_4}
  \todo{Change $(\T_i,\F_i)$ with something like $\t_1,\t_2$}
...
\todo{Remove reference to compatible torsion pairs. Use related torsion pairs and Nakaoka contexts}
...
\begin{prop}
  ...
  \item $\mathbbm{t}$ is a compatible torsion pair in $\mathcal{T}$; \todo{Compatible mean satisfying (CT1)-(CT3),(CT3)$^\ast$}
