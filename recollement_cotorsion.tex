...
\end{prop}
 ...
 \begin{rem}
   The above proposition applies, for example, to the case of the cotorsion pair $(\A,\B)$ over a commutative ring $R$ generated by the set $\{R[s^-1]~|~s\in R\}$. The class $\A$ is called the class of very flat modules, and $\A\subseteq \Flat\cap \clP_1$.
 \end{rem}
  %
