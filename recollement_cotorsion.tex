...
\begin{abstract} We consider a complete hereditary cotorsion pair $(\mathcal{A},\mathcal{B})$ in a Grothendieck category $\mathcal{G}$, such that $\A$ contains a generator of finite projective dimension. The derived category $\D(\B)$ of the exact category $\B$ is defined as the quotient of the category $\Ch(\B)$, of unbounded complexes with terms in $\B$, modulo the subcategory $\widetilde{\B}$ consisting of the acyclic complexes with terms in $\B$ and cycles in $\B$.
%

We prove that there are recollements
$
\xymatrix{\dfrac{ex\B}{\sim} \ar[r]^{inc} &{\D(\B)} \ar@/^1pc/[l]\ar@/_1pc/[l] \ar[r]^{Q}
                                          &{\D(\G)}\ar@/^1pc/ [l] \ar@/_1pc/ [l] }
$
and
$
...
Then, we restrict our attention to the cotorsion pairs such that
...
$
\xymatrix{\dfrac{ex\B}{\sim} \ar[r]^{inc} &{K(\B)} \ar@/^1pc/[l]\ar@/_1pc/[l] \ar[r]^{Q}
                                          &{\D(\B)}\ar@/^1pc/ [l] \ar@/_1pc/ [l] }
.$


%
We will explore the conditions under which $\mathrm{ex}\,\mathcal{B}=\widetilde{\mathcal{B}}$ and provide some examples.
...
If $(\A, \B)$ is a complete hereditary cotorsion pair in a Grothendieck  category $\G$ with enough projective objects,
$(dg\Proj, \E )$ is a projective cotorsion pair in $\Ch(\G)$ satisfying the assumptions of Proposition~\ref{P:7.2-Groth}. Hence, we have the projective cotorsion pair:
  \[\Big(dg\Proj, ex\A\Big)\]  in $\Ch(\A)$ and the localizing cotorsion pair $\Big([dg\Proj]_K, ex\A\Big)$ in $\Ch(\A)_{dw}.$
