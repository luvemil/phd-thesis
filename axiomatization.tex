...
\begin{definition}
  ...
  \begin{enumerate}
    \item[(CT1)] $\mathbb{t}_1=(\mathcal{T}_1,\mathcal{F}_1)$ and $\mathbb{t}_2=(\mathcal{T}_2,\mathcal{F}_2)$ are respectively a left functorial and a
    right functorial torsion pair \todo{define torsion pairs in additive categories}
    \item[(CT2)] $\mathcal{T}_2\subseteq \mathcal{T}_1$ (equiv. $\mathcal{F}_1\subseteq\mathcal{F}_2$)
    \item[(CT3)] Any morphism $g:T_1\to T_1'$ in $\mathcal{T}_1$ iadmits a pseudocokernel $g^C:T_1'\to\PCok_\mathcal{X}(g)$,
...
\begin{definition}
  ...
  \begin{enumerate}
    \item[(CT4)] Let $f:H_1\to H_2$ in $\mathcal{H}$ be such that there is a pseudokernel
...
\begin{thm}
  ...
  equivalent:
  \begin{enumerate}
    \item[(a)] $\mathbb{t}$ is strong,
    \item[(b)] $\mathcal{H}$ is an abelian category.
  \end{enumerate}
\end{thm}
