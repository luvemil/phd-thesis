...
\begin{lem}\label{lem1_2} Let $(\A,\B)$ be a cotorsion pair in a Grothendieck category generated by a set $\clS$. Then, $\A$ is generating if and only if $(\A,\B)$ is complete.
