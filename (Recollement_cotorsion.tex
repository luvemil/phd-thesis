...
\item Also the hereditary complete cotorsion pair $(dg\A, \widetilde{\B})$ in $\Ch(\G)$ satisfies the conditions in  Proposition~\ref{P:prop7.3},  hence we have the injective cotorsion pair:
...
\item If $\A$ is deconstructible, then by Proposition~\ref{P:complete?}~(6) $(ex\A, ex\A{}^\perp{})$ is a hereditary complete cotorsion pair in $\Ch(\G)$ and it satisfies the conditions in Proposition~\ref{P:prop7.3}, hence we have the injective cotorsion pair
...
\begin{prop}\label{P:A-flat} Let $(\A, \B)$ be a hereditary complete cotorsion pair in $\Modr R$. Assume that $\A\subseteq \Flat$ and that $\A\subseteq \clP_n$, where $\clP_n$ is the class of modules of projective dimension at most $n$.
