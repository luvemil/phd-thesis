...
\newcommand{\iSpec}{\operatorname{iSpec}}  %
\newcommand{\Inter}{\operatorname{Inter}}  %
\newcommand{\res}{\operatorname{res}}      %
\newcommand{\OO}{\mathcal{O}}              %
\newcommand{\PP}[2]{\mathbb{P}^{#1}_{#2}}  %
...
%
 ...
 The next Proposition~\ref{P:prop7.3} is a generalization of \cite[Propostion 7.3]{G7} which was formulated for the case of the cotorsion pair $(\F, \C)$ in a module category. %
...
\end{expl}
 ...
 The above three examples $\Gamma_1, \Gamma_2, \Gamma_3$ of projective cotorsion pairs  in $\Ch(\A)$ satisfy the assumptions of \cite[Theorem 3.5]{G7}. Hence we obtain:
  %
  \begin{thm}\label{T:recollement-proj-A} If $\G$ is a Grothendieck category with enough projective objects and $(\A, \B)$ is a hereditary complete cotorsion pair in $\G$, there is a recollement %
%
