...
\begin{definition}
  ...
  \begin{enumerate}[label=(\alph*)]
    ...
    \item for any $X\in\mathcal{T}$ there is a distinguished triangle
      \begin{equation*}
        \begin{tikzcd}
...
\todo{Is this definition correct? Shouldn't we ask for the functoriality in this stage, given the definition of a torsion pair that was given above?}
...
The difference here with the definition of torsion pair that we gave earlier is that we are asking for the pseudokernel-pseudocokernel sequence to actually be a distinguished triangle.
